...
register(
    id='CartPoleUnlimited-v0',
    entry_point='envs.CartPoleUnlimited:CartPoleEnv',
)

register(
    id='CartPoleContinuous-v0',
    entry_point='envs.CartPoleContinuous:ContinuousCartPoleEnv',
)

register(
    id='SLIP-v0',
    entry_point='envs.slip:SlipEnv',
)
